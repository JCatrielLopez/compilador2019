...
case 1:
//#line 39 "src/main/resources/gramatica.y"
...
break;
case 8:
//#line 50 "src/main/resources/gramatica.y"
...
break;
case 18:
//#line 66 "src/main/resources/gramatica.y"
...
break;
case 24:
//#line 76 "src/main/resources/gramatica.y"
...
//#line 106 "src/main/resources/gramatica.y"
{
  ...
  if (this.verbose)
    Printer.print(String.format("%5s %s %3s %s %s", al.getLineNumber(), "|", "AS", "|", "Se encontro una sentencia Print."));
}
break;
case 38:
...
break;
case 62:
//#line 142 "src/main/resources/gramatica.y"
{Error.add(String.format("%5s %s %3s %s %s", al.getLineNumber(), "|", "AS", "|", "ERROR en la condicion de IF."));}
break;
case 63:
//#line 143 "src/main/resources/gramatica.y"
{Error.add(String.format("%5s %s %3s %s %s", al.getLineNumber(), "|", "AS", "|", "ERROR Falta el literal ';'."));}
break;
case 64:
//#line 144 "src/main/resources/gramatica.y"
...
break;
case 67:
//#line 147 "src/main/resources/gramatica.y"
...
break;
case 95:
//#line 222 "src/main/resources/gramatica.y"
{ yyval = new ParserVal(crearTercetoOperacion("-", val_peek(2).sval, val_peek(0).sval)); }
break;
case 97:
//#line 224 "src/main/resources/gramatica.y"
{Error.add(String.format("%5s %s %3s %s %s", al.getLineNumber(), "|", "AS", "|", "ERROR Falta un termino en la operacion '+'"));}
break;
case 98:
//#line 225 "src/main/resources/gramatica.y"
{Error.add(String.format("%5s %s %3s %s %s", al.getLineNumber(), "|", "AS", "|", "ERROR Falta un termino en la operacion '-'"));}
break;
case 99:
...
break;
case 103:
//#line 232 "src/main/resources/gramatica.y"
{Error.add(String.format("%5s %s %3s %s %s", al.getLineNumber(), "|", "AS", "|", "ERROR Falta un termino en la operacion '*"));}
break;
case 104:
//#line 233 "src/main/resources/gramatica.y"
{Error.add(String.format("%5s %s %3s %s %s", al.getLineNumber(), "|", "AS", "|", "ERROR Falta un termino en la operacion '/'"));}
break;
case 105:
//#line 234 "src/main/resources/gramatica.y"
{Error.add(String.format("%5s %s %3s %s %s", al.getLineNumber(), "|", "AS", "|", "ERROR Falta un termino en la operacion '/'"));}
break;
case 108:
...
break;
case 116:
//#line 259 "src/main/resources/gramatica.y"
{Error.add(String.format("%5s %s %3s %s %s", al.getLineNumber(), "|", "AS", "|", "ERROR Funcion desconocida."));}
break;
case 117:
...
break;
case 118:
//#line 270 "src/main/resources/gramatica.y"
{
						    Token coleccion = SymbolTable.getLex(val_peek(3).sval);
